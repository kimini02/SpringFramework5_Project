...
public class ManageBook {
    ...
    public static void main(String[] args) {
        ...
        // 가격 변경 (7번째 도서 - 작별하지않는다)
        System.out.println("\n==== 가격 변경 ====");
        int index = 6;  // 작별하지않는다
        int originalPrice = publications[index].getPrice();
        System.out.println(publications[index].getTitle() + " 변경 전 가격: " + originalPrice + "원");
        
        modifyPrice(publications[index]);
        
        int newPrice = publications[index].getPrice();
        System.out.println(publications[index].getTitle() + " 변경 후 가격: " + newPrice + "원");
